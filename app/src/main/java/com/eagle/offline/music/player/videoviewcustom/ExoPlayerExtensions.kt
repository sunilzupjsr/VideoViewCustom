...
import com.eagle.offline.music.player.videoviewcustom.R
...
fun SimpleExoPlayer.preparePlayer(playerView: PlayerView, forceLandscape:Boolean = false) {
    (playerView.context as AppCompatActivity).apply {
        ...
        fullScreenButton.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_fill_favorite))
        normalScreenButton.setImageDrawable(ContextCompat.getDrawable(this, R.drawable.ic_favorite))
